...
const es: typeof en = {
  ...
  schedule: {
    ...
    customerPrefers: "El cliente pidió estos:",
  ...
  finish: {
    ...
    scheduledNote: "Instalación programada. El cliente recibe un recordatorio para confirmar dos días antes.",
    hint: "Cuando el trabajo esté hecho en el sitio, márcalo como terminado para agradecer al cliente y pedirle una reseña.",
  ...
  settings: {
    ...
    hoursHint:
      "Cuando los clientes pueden reservar una visita de cotización contigo. Las visitas se ofrecen en punto, una tras otra, con una hora de diferencia.",
    hoursFrom: "Primera visita a las",
    hoursTo: "Última visita a las",
    hoursDays: "Días que aceptas visitas",
    hoursPreview: "Los clientes verán:",
    hoursNoDays: "Elige al menos un día, si no nadie podrá reservarte.",
    hoursBackwards: "La última visita no puede ser antes que la primera.",
    hoursNote:
      "Esto solo cambia lo que se le ofrece al cliente. Tú puedes reservar una visita a cualquier hora desde la página del trabajo.",
  },
  calendar: {
    title: "Calendario",
  ...
  addOption: {
    open: "Enviarle otra opción",
    openHint: "{name} tiene esta cotización. Agrega una segunda forma de hacer el trabajo y podrá comparar ambas en el mismo enlace.",
    title: "Enviar otra opción",
    close: "Cerrar",
    leadConvert:
      "{name} ya tiene un precio. Ponle un nombre, agrega la segunda forma de hacer el trabajo y le enviaremos un enlace que muestra las dos juntas.",
    leadAdd: "Agrega otra forma de hacer el trabajo. {name} la verá junto a las que ya tiene.",
    keepLegend: "La cotización que ya tiene",
    keepHint: "Este es el precio que ya está en su teléfono. Ponle un nombre para distinguirlas, y corrige la cifra si hace falta.",
    keepNamePlaceholder: "ej. Entrada de concreto",
    alreadyOffered: "Ya está en esta cotización",
    addLegend: "La nueva opción",
    addHint: "La otra forma de hacer el mismo trabajo. Con su propio precio, no un descuento sobre el primero.",
    addNamePlaceholder: "ej. Entrada de asfalto",
    addCoversPlaceholder: "Qué recibe y en qué se diferencia de la otra opción.",
    name: "Cómo se llama",
    price: "Precio ($)",
    covers: "Por qué elegiría esta",
    coversPlaceholder: "Lo que incluye específicamente esta.",
    recommendLabel: "¿Cuál recomendarías?",
    recommendNone: "Sin recomendación",
    previewLabel: "Lo que verá {name}",
    previewUnnamed: "Sin nombre todavía",
    previewNote: "Elige una y ahí se define su precio. El enlace es el mismo que ya tiene, y el mensaje nunca lleva precio.",
    send: "Enviar ambas a {name}",
    sending: "Enviando...",
    cancel: "Cancelar",
    needBoth: "Cada opción necesita nombre y precio antes de poder enviarse.",
    sentOk: "Enviado. {name} ya puede comparar ambas opciones en su enlace.",
    sentHeld: "Guardado. El mensaje sale {when}.",
    sentFailed: "La opción se guardó, pero el mensaje NO salió. Envíale el enlace tú mismo.",
  },
  quoteLog: {
  ...
  acceptOffline: {
    ...
    yes: "La tomó",
    no: "La dejó",
    agreedTotal: "Precio acordado:",
    bookNow: "Acordamos un día en la llamada",
    bookNowHint: "Lo agenda en ese momento. Déjalo sin marcar si el día todavía está abierto y lo van a definir después.",
    startTime: "Hora de inicio",
    notifyLabel: "Mandar mensaje a {name} para confirmar",
    notifyHint: "Su registro escrito de la llamada. Desactívalo si todavía estás al teléfono con el cliente.",
    notifyHintBooked: "Le manda el día y la hora que acaban de acordar. Desactívalo si todavía estás al teléfono con el cliente.",
    warn: "Esto marca la cotización como aprobada a nombre de {name}. El registro guarda que lo hiciste tú y que vino de una llamada, así que úsalo solo cuando de verdad hayan dicho que sí.",
    record: "Registrar la aprobación",
    recordAndBook: "Registrarla y agendar el día",
    recording: "Registrando…",
    cancel: "Todavía no",
    answerAll: "Primero marca cada partida opcional como la tomó o la dejó.",
    tookNothing: "Dejó todas las partidas. Eso es una cotización rechazada - pide a la oficina que la marque como perdida.",
  },
  contractorJob: {
    ...
    schedWaiting: "El cliente aprobó y pidió estos días y horas. Toca el que te sirva y le avisamos por mensaje enseguida.",
    ...
    log: {
      ...
      quoteOptionAdded: "Otra opción enviada: {title}",
      customerViewed: "El cliente abrió la cotización",
      customerAccepted: "El cliente aprobó la cotización",
      customerAcceptedPhone: "Aprobación registrada de una llamada",
    ...
    visitNotBooked: "Todavía sin reservar",
    ...
    quotePriceLabel: "Precio total",
    quoteTotalLabel: "Total, calculado con las opciones de abajo",
    quoteIncluded: "Qué incluye",
    quoteDone: "{n} de 5 listas",
    quotePreviewOpen: "Ver lo que ve {name}",
    quotePreviewClose: "Ocultar vista previa",
    quotePreviewNote: "Así se ve en el teléfono de {name}. El cliente lo lee en inglés.",
    quoteNeedPrice: "Pon un precio para enviarla.",
    quoteNeedSections: "Llena {n} más para enviarla. Toca No aplica si una no aplica.",
    sections: {
      quote_scope: "Alcance",
  ...
  payments: {
    ...
    total: "Total del trabajo",
    paid: "Pagado hasta ahora",
    due: "Falta cobrar",
    settled: "Pagado por completo",
    noPrice: "Este trabajo todavía no tiene precio, así que no hay nada que cobrar.",
    owedTitle: "Tu comisión para la oficina",
    officeCut: "Comisión de la oficina",
    feeTaken: "cobrado por tarjeta",
    feeLeft: "todavía pendiente",
    owedNone: "No debes nada: salió del pago con tarjeta.",
    owedCard: "Sale automáticamente de los pagos con tarjeta.",
    owedCash: "Mándalo por Zelle o Venmo cuando puedas.",
    cardTitle: "Mándale un enlace de pago",
    cardLead: "Tarjeta, Apple Pay o Google Pay. El dinero entra a tu cuenta de Stripe, no a la de la oficina.",
    cardSend: "Enviar el enlace de pago",
    cardSending: "Enviando…",
    cardOff: "Todavía no tienes pagos con tarjeta activados: pídeselo a la oficina.",
    cashTitle: "Registra lo que te entregaron",
    cashLead: "Efectivo, cheque, Zelle o Venmo. Cuenta de inmediato y la oficina recibe un mensaje.",
    amount: "¿Cuánto?",
    method: "¿Cómo pagaron?",
    noteLabel: "Nota (opcional)",
    notePlaceholder: "Algo que la oficina deba saber",
    record: "Registrar este pago",
    recording: "Guardando…",
    needAmount: "Escribe cuánto te pagaron.",
    history: "Pagos hasta ahora",
    waiting: "esperando al banco",
    refunded: "reembolsado",
    refund: "Reembolsar",
    refunding: "Reembolsando…",
    refundAsk: "¿Devolver {amount} al cliente? La comisión de la oficina regresa también.",
    methods: {
      card: "Tarjeta",
      cash: "Efectivo",
      venmo: "Venmo",
