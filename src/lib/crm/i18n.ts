...
const es: typeof en = {
  ...
  contractorJob: {
    ...
    checkPhotos: "Tomaste fotos del trabajo terminado",
    ...
    finishAllRequired: "Marca las cuatro casillas para cerrar este trabajo.",
