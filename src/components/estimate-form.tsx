  ...
  return (
    <form className="quote-form" onSubmit={onSubmit} noValidate>
      ...
      <label className="estimate-consent">
        ...
        />
        <span>
          I agree to receive text messages from Raleigh Concrete Group about my quote request,
          appointment reminders, and project updates. Message frequency varies. Message &amp; data
          rates may apply. Reply HELP for help or STOP to unsubscribe at any time. See our{" "}
